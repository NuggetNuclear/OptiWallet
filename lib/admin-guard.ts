 ...
 * closest trusted proxy, which is the hardest for the client to forge. (audit M2)
 */
...
export async function recordFailedAttempt(ip: string): Promise<void> {
  ...
  // would otherwise accumulate forever. Best-effort — never block the auth path. (audit L5)
  try {
